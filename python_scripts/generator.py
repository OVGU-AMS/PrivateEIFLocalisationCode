...
def generate_sim_inputs(track_filepath, sensor_filepath_base, number_of_sims, sensor_locations, first_sensor_index, number_of_sensors):
...
if __name__ == "__main__":
    generate_sim_inputs(TRACK_FILEPATH_DEFAULT, SENSOR_FILEPATH_BASE_DEFAULT, NUM_SIMS_DEFAULT, SENSOR_LOCATIONS_DEFAULT, FIRST_SENSOR_INDEX_DEFAULT, NUM_SENSORS_DEFAULT)